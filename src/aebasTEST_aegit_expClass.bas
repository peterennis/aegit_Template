...
Public Sub aegit_Template_EXPORT(Optional ByVal varDebug As Variant)
    ...
    Const THE_SOURCE_FOLDER = ".\src\"                  ' "C:\THE\DATABASE\PATH\src\"
    Const THE_EXPORT_FOLDER = ".\src\exp\"              ' "C:\THE\DATABASE\PATH\src\exp\"
    Const THE_XML_FOLDER = ".\src\xml\"                 ' "C:\THE\DATABASE\PATH\src\xml\"
    Const THE_XML_DATA_FOLDER = ".\src\xmldata\"        ' "C:\THE\DATABASE\PATH\src\xmldata\"
    Const THE_BACK_END_DB1 = "NONE"
    Const THE_BACK_END_SOURCE_FOLDER = "NONE"           ' ".\srcbe\"
    Const THE_BACK_END_XML_FOLDER = "NONE"              ' ".\srcbe\xml\"
    Const THE_BACK_END_XML_DATA_FOLDER = "NONE"         ' ".\srcbe\xmldata\"
